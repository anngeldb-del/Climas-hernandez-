 ...
 * views never need a join, and total/balance bookkeeping.
 */
...
export function computeTotal(partsItems, laborCost) {
  const partsTotal = (partsItems || []).reduce((sum, r) => sum + (Number(r.quantity) || 0) * (Number(r.unitPrice) || 0), 0);
